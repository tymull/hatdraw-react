            ...
            <div class="section">
                <form>
                    <div class="form-group">
                      <label class="label-instructions" for="raffleHatTextarea">Enter
                        each entry (name, number, etc.) on its own line in the field below.
                      </label>
                      <textarea class="form-control form-control-lg" id="exchangeHatTextarea" rows="7" placeholder="Name 1" value={names} onChange={e => setNames(e.target.value)}></textarea>
                    ...
                    <div class="form-group">
                        <label class="label-instructions" for="exchangeHatTextarea">Enter the
                          number of prizes being raffled (if there are more prizes than entries,
                          hat will be refilled when empty)</label>
                        <input type="number" class="form-control form-control-lg" id="exchangeHatTextarea" rows="1" min="1" value={numPrizes} onChange={e => setNumPrizes(e.target.value)}/>
                    </div>
                    <div class="form-group">
                      <button type="submit" class="btn btn-primary" onClick={handleClick}>Draw</button>
                    </div>
